            ...
            >
              <div>
                ...
                {biasData && biasData.top_drivers.length > 0 && (
                  <Tooltip
                    ...
                    position="top"
                  >
                    <div className="text-[11px] text-slate-300 bg-slate-950/40 rounded p-1.5 border border-slate-800/50 mb-2 leading-tight cursor-help hover:border-slate-700 transition">
              ...
              <div className="pt-2 border-t border-slate-800/80 font-mono text-[10px]">
                <div className="flex items-center justify-between text-slate-500 text-[9px]">
                  <MetricTooltip term="FRESHNESS" underline={false}>
                    <span className="truncate max-w-[120px] cursor-help hover:text-slate-300" title={`${item.source} • Sync: ${formattedTime}`}>
                      {item.source}
                    </span>
                  </MetricTooltip>
                  <div className="flex items-center gap-1">
                    ...
                    <MetricTooltip term="SSE_STATUS" underline={false}>
                      <span className={`font-bold px-1 py-0.2 rounded text-[8px] border cursor-help ${
                        item.status === 'LIVE'
