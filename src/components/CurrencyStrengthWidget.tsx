...
export const CurrencyStrengthWidget: React.FC<CurrencyStrengthWidgetProps> = ({
  ...
  const [subTab, setSubTab] = useState<'LIVE' | 'COMPARISON' | 'ARCHIVE'>('LIVE');
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 flex flex-col h-full">
      ...
      {/* Mode Sub-Tabs */}
      <div className="grid grid-cols-3 gap-1 bg-slate-900/80 p-1 rounded-lg mb-3 border border-slate-800/80 text-[10px] font-mono">
        <button
